...
import json
with open("/home/mlmi-matthias/Caghan/mlmi-vqa/data/external/mimic_cxr_all.json", "w") as final:
   json.dump(valid_list, final, indent=2)
with open("/home/mlmi-matthias/Caghan/mlmi-vqa/data/external/mimic_cxr_all.json", "r") as f:
...
with open("/home/mlmi-matthias/Caghan/mlmi-vqa/data/external/mimic_cxr_train.json", "w") as final:
   json.dump(train_split, final, indent=2)

with open("/home/mlmi-matthias/Caghan/mlmi-vqa/data/external/mimic_cxr_val.json", "w") as final:
   json.dump(val_split, final, indent=2)

with open("/home/mlmi-matthias/Caghan/mlmi-vqa/data/external/mimic_cxr_test.json", "w") as final:
