...
mimic_datamodule = RAD_CLEF_Mixed_DataModule(
...
ATT_HEAD_DIM = 64
CROOS_ATT_EVERY=3
MEDIA_TOKEN_ID = mimic_datamodule.tokenizer.\
    all_special_ids[mimic_datamodule.tokenizer.all_special_tokens.index('<image>')]
